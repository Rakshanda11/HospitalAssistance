...
class mainNavigation extends React.Component{
  ...
  render(){
    return (
      <header className="main-navigation-reception">
        <nav className="main-navigation__items-reception">
          <div className="toolbar__toggle-button-reception">
            <DrawerToggleButton
              click={this.props.drawerClickHandler}
            ></DrawerToggleButton>
          </div>
          <div className="main-navigation__logo-reception">
            <h1>CarePlus</h1>
          </div>
          <div className="spacer"></div>
          <div className="main-navigation__div-reception">
